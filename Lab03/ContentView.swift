...
//  Lab03
//
//  Created by igormac on 06.02.2022.
//  Copyright © 2022 igormac. All rights reserved.
//
                ...
                VStack (spacing: 1){
                    ...
                    HStack (spacing: 1){
                        ...
                        Button(action: {
                            ...
                            ZStack {
                                Color("btn_special")
                                Image("plusminus").scaleEffect(0.6)
                            }
                        }
                        Button(action: {
                    ...
                    HStack (spacing: 1){
                        ...
                        Button(action: {
                            ...
                            ZStack {
                                Color("btn_action")
                                Image("multiply").scaleEffect(0.3)
                            }
                        }
                    }.frame(height: UIScreen.main.bounds.width / 4)
                    HStack (spacing: 1){
